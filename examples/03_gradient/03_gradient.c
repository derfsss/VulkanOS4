/*
** Vulkan Gradient -- AmigaOS 4
**
** Renders a fullscreen gradient quad using TRIANGLE_STRIP topology
** (4 vertices, 2 triangles). Corners are coloured:
**   top-left = red, top-right = yellow,
**   bottom-left = blue, bottom-right = green
**
** Demonstrates: TRIANGLE_STRIP topology, fullscreen quad rendering,
** 4-vertex barycentric interpolation across two triangles.
**
** Compile: ppc-amigaos-gcc -mcrt=newlib -D__USE_INLINE__
**          -o gradient gradient.c -lvulkan_loader -lauto
*/
...
int main(int argc, char **argv)
{
    ...
    printf("=== Vulkan Gradient Quad Demo ===\n");
    ...
    ai.pApplicationName = "Vulkan Gradient";
