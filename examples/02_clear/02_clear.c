/*
** Vulkan Clear -- AmigaOS 4
**
** Cycles through clear colours in a render loop. Demonstrates WSI
** presentation without any shaders or graphics pipeline -- just
** vkCmdBeginRendering with VK_ATTACHMENT_LOAD_OP_CLEAR.
**
** Press close gadget to exit.
**
** Compile: ppc-amigaos-gcc -mcrt=newlib -D__USE_INLINE__
**          -o clear clear.c -lvulkan_loader -lauto
*/
...
int main(int argc, char **argv)
{
    ...
    printf("=== Vulkan Clear Colour Demo ===\n");
    ...
    appInfo.pApplicationName = "Vulkan Clear";
    ...
    printf("Cycling clear colours... close window to exit.\n");
    ...
    while (running)
    {
        ...
        uint32_t phase = (frame / 30) % 6;
        float t = (float)(frame % 30) / 30.0f;

        switch (phase)
        {
            case 0: r = 1.0f;      g = t;         b = 0.0f;      break; /* red -> yellow */
            case 1: r = 1.0f - t;  g = 1.0f;      b = 0.0f;      break; /* yellow -> green */
            case 2: r = 0.0f;      g = 1.0f;      b = t;         break; /* green -> cyan */
            case 3: r = 0.0f;      g = 1.0f - t;  b = 1.0f;      break; /* cyan -> blue */
            case 4: r = t;         g = 0.0f;      b = 1.0f;      break; /* blue -> magenta */
            case 5: r = 1.0f;      g = 0.0f;      b = 1.0f - t;  break; /* magenta -> red */
        }
        ...
        /* Record: just a clear, no pipeline needed */
