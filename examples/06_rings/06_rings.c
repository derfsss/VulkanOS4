/*
** Vulkan Rings -- AmigaOS 4
**
** Renders a fullscreen quad using TRIANGLE_STRIP topology
** (4 vertices, 2 triangles) with concentric ring patterns.
**
** Demonstrates OpExtInst Length/Fract/SmoothStep/FClamp/FMix
**
** Compile: ppc-amigaos-gcc -mcrt=newlib -D__USE_INLINE__
**          -o rings rings.c -lvulkan_loader -lauto
*/
...
int main(int argc, char **argv)
{
    ...
    ai.pApplicationName = "Vulkan Rings";
    ...
    printf("Rings rendered! (uses OpExtInst Length, Fract, SmoothStep, FClamp, FMix)\n");
