/*
** Vulkan Rotating Triangle -- AmigaOS 4
**
** Demonstrates push constants: the rotation angle is passed to the
** vertex shader each frame via vkCmdPushConstants. The shader uses
** sin/cos to rotate the triangle vertices.
**
** This is the first animated Vulkan rendering on AmigaOS 4.
**
** Compile: ppc-amigaos-gcc -mcrt=newlib -D__USE_INLINE__
**          -o rotating rotating.c -lvulkan_loader -lauto
*/
...
int main(int argc, char **argv)
{
    ...
    printf("=== Vulkan Rotating Triangle ===\n");
    ...
    ai.pApplicationName = "Rotating Triangle";
    ...
    window = OpenWindowTags(NULL,
        WA_Title, (Tag)"Vulkan Rotating Triangle",
    ...
    pcRange.offset = 0;
    pcRange.size = sizeof(float);  /* just the angle */
    ...
    printf("Rotating triangle... close window to exit.\n");

    /* Render loop with push constants */
    float angle = 0.0f;
    uint32_t frame = 0;
    ...
    while (running)
    {
        ...
        ca.clearValue.color.float32[2] = 0.2f;
