/*
** Vulkan Checkerboard -- AmigaOS 4
**
** Renders a checkerboard pattern using SPIR-V shader opcodes:
**   - OpExtInst (GLSL.std.450 Floor)
**   - OpFOrdLessThan (float comparison)
**   - OpBranchConditional (if/else control flow)
**   - OpSelectionMerge (merge point)
**
** Demonstrates: Extended math functions, comparisons, branching in
** fragment shader. Uses TRIANGLE_STRIP for fullscreen quad.
**
** Compile: ppc-amigaos-gcc -mcrt=newlib -D__USE_INLINE__
**          -o checkerboard checkerboard.c -lvulkan_loader -lauto
*/
...
int main(int argc, char **argv)
{
    ...
    ai.pApplicationName = "Checkerboard";
    ...
    window = OpenWindowTags(NULL,
        WA_Title, (Tag)"Vulkan Checkerboard",
    ...
    printf("Shader modules created (uses OpExtInst Floor, OpFOrdLessThan, OpBranchConditional)\n");
    ...
    { printf("ERROR: pipeline creation\n"); exitCode = 1; goto cleanup; }
